...
@Slf4j
@Component
public class JsonKafkaProducerImpl<K extends Serializable, V> implements KafkaProducer<K, V> {

    private final KafkaTemplate<K, V> kafkaTemplate;

    public JsonKafkaProducerImpl(@Qualifier("jsonKafkaTemplate") KafkaTemplate<K, V> kafkaTemplate) {
    ...
    @PreDestroy
    public void close() {
        log.info("Closing JSON Kafka producer!");
