...
public class MsdControllerIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        Map<String, Object> consumerProps = KafkaTestUtils.consumerProps("msd-group", "true", embeddedKafkaBroker);
    ...
    void testSendMessage() {
        ...
        ResponseEntity<Void> response = restTemplate.getForEntity("/msd", Void.class);
