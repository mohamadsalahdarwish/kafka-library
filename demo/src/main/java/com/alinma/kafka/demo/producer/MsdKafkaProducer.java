...
@Component
public class MsdKafkaProducer {

    private final KafkaProducer<String, String> kafkaProducer;

    @Autowired
    public MsdKafkaProducer(JsonKafkaProducerImpl<String, String> kafkaProducer) {
        this.kafkaProducer = kafkaProducer;
    }

    public void send(String key, String message) {
        kafkaProducer.send("msd-topic", key, message, new KafkaSendCallback<String, String>() {
            @Override
            public void onSuccess(SendResult<String, String> result) {
                // Handle success
                System.out.println("Message sent successfully to 'msd-topic' with key: " + key);
            }
